  ...
  switch (code) {
    ...
    case '670z':
      values = {
        ...
        '23' : {value : 'Ev (256-461)', description : 'Ev (256-461)'},
    ...
    case '670y':
      values = {
        ...
        '7' : {value : 'Bienenberg Gesch. Königgrätz ', description : 'Bienenberg Gesch. Königgrätz '},
        ...
        '18' : {value : 'DD', description : 'DD'},
        '19' : {value : 'DZ', description : 'DZ'},
        '20' : {value : 'Dačický ', description : 'Dačický '},
        '21' : {value : 'Demuth G. d. L. ', description : 'Demuth G. d. L. '},
        '22' : {value : 'Dobner Mon. ', description : 'Dobner Mon. '},
        '23' : {value : 'Dörr der Adel ', description : 'Dörr der Adel '},
        '24' : {value : 'Dvorský Paměti žen ', description : 'Dvorský Paměti žen '},
        '25' : {value : 'Emler Tab. vet. ', description : 'Emler Tab. vet. '},
        '26' : {value : 'Emler urbáře ', description : 'Emler urbáře '},
        '27' : {value : 'Font. r. Boh. ', description : 'Font. r. Boh. '},
        '28' : {value : 'Glafey Anecd. ', description : 'Glafey Anecd. '},
        '29' : {value : 'Glatzer Gesch. ', description : 'Glatzer Gesch. '},
        '30' : {value : 'Goll Čechy a Prusy ', description : 'Goll Čechy a Prusy '},
        '31' : {value : 'Heber´s Burgen ', description : 'Heber´s Burgen '},
        '32' : {value : 'Höfler ', description : 'Höfler '},
        '33' : {value : 'Chlumecký Reg. ', description : 'Chlumecký Reg. '},
        '34' : {value : 'Jirečk. Ruk. ', description : 'Jirečk. Ruk. '},
        '35' : {value : 'Jungm. h. l. ', description : 'Jungm. h. l. '},
        '36' : {value : 'Kapras Kn. sv. Bydžov. ', description : 'Kapras Kn. sv. Bydžov. '},
        '37' : {value : 'Kopecký Reg. ', description : 'Kopecký Reg. '},
        '38' : {value : 'Lupáč ', description : 'Lupáč '},
        '39' : {value : 'Mars Morav. ', description : 'Mars Morav. '},
        '40' : {value : 'Menčík Pam. Harant. ', description : 'Menčík Pam. Harant. '},
        '41' : {value : 'Miscellanea', description : 'Miscellanea'},
        '42' : {value : 'Mon. univ. Prag. ', description : 'Mon. univ. Prag. '},
        '43' : {value : 'Mon. Vat. ', description : 'Mon. Vat. '},
        '44' : {value : 'MVGDB ', description : 'MVGDB '},
        '45' : {value : 'Nedopil ', description : 'Nedopil '},
        '46' : {value : 'Neues Laus. Mag. ', description : 'Neues Laus. Mag. '},
        '47' : {value : 'Palacký ', description : 'Palacký '},
        '48' : {value : 'Palacký Doc. ', description : 'Palacký Doc. '},
        '49' : {value : 'Palacký formelb. ', description : 'Palacký formelb. '},
        '50' : {value : 'Palacký UB ', description : 'Palacký UB '},
        '51' : {value : 'Pam. arch. ', description : 'Pam. arch. '},
        '52' : {value : 'Pam. Dačického ', description : 'Pam. Dačického '},
        '53' : {value : 'Pangerl Die Witigonen ', description : 'Pangerl Die Witigonen '},
        '54' : {value : 'Pangerl G. U. ', description : 'Pangerl G. U. '},
        '55' : {value : 'Pangerl Hoh. Urk. ', description : 'Pangerl Hoh. Urk. '},
        '56' : {value : 'Paproc. o st. pan. ', description : 'Paproc. o st. pan. '},
        '57' : {value : 'Paproc. o st. ryt. ', description : 'Paproc. o st. ryt. '},
        '58' : {value : 'Pelzel Urkdbch ', description : 'Pelzel Urkdbch '},
        '59' : {value : 'Pescheck Exulanten ', description : 'Pescheck Exulanten '},
        '60' : {value : 'Podlaha Lib. conf. ', description : 'Podlaha Lib. conf. '},
        '61' : {value : 'Podlaha Lib. erect. ', description : 'Podlaha Lib. erect. '},
        '62' : {value : 'Podlaha Lib. ord. ', description : 'Podlaha Lib. ord. '},
        '63' : {value : 'Reg. ', description : 'Reg. '},
        '64' : {value : 'Rel. tab. ', description : 'Rel. tab. '},
        '65' : {value : 'RI', description : 'RI'},
        '66' : {value : 'Riegger Arch. ', description : 'Riegger Arch. '},
        '67' : {value : 'Rozvržení ', description : 'Rozvržení '},
        '68' : {value : 'Script. rer. Lus. ', description : 'Script. rer. Lus. '},
        '69' : {value : 'Schaller ', description : 'Schaller '},
        '70' : {value : 'Schaller Prag ', description : 'Schaller Prag '},
        '71' : {value : 'Schönfeld Adels Schematismus ', description : 'Schönfeld Adels Schematismus '},
        '72' : {value : 'Schriften ', description : 'Schriften '},
        '73' : {value : 'Schulz Soupis reg. soudu nejv. purkr. ', description : 'Schulz Soupis reg. soudu nejv. purkr. '},
        '74' : {value : 'Slavík Děje Vlašimě ', description : 'Slavík Děje Vlašimě '},
        '75' : {value : 'Sommer', description : 'Sommer'},
        '76' : {value : 'Soupis ', description : 'Soupis '},
        '77' : {value : 'St. letop. ', description : 'St. letop. '},
        '78' : {value : 'Steinbach ', description : 'Steinbach '},
        '79' : {value : 'Stocklöw Tachau ', description : 'Stocklöw Tachau '},
        '80' : {value : 'Strnad Listář Plzenský ', description : 'Strnad Listář Plzenský '},
        '81' : {value : 'Švenda Želez. obraz ', description : 'Švenda Želez. obraz '},
        '82' : {value : 'Tadra Acta iud. ', description : 'Tadra Acta iud. '},
        '83' : {value : 'Tadra Canc. Arn. ', description : 'Tadra Canc. Arn. '},
        '84' : {value : 'Tadra Kanceláře a písaři ', description : 'Tadra Kanceláře a písaři '},
        '85' : {value : 'Tadra Listy Zbrasl. ', description : 'Tadra Listy Zbrasl. '},
        '86' : {value : 'Teige Zákl. ', description : 'Teige Zákl. '},
        '87' : {value : 'Theobald ', description : 'Theobald '},
        '88' : {value : 'Tischer Dopisy ', description : 'Tischer Dopisy '},
        '89' : {value : 'Tomek Děje Prahy ', description : 'Tomek Děje Prahy '},
        '90' : {value : 'Truhlář Rukopisy ', description : 'Truhlář Rukopisy '},
        '91' : {value : 'Truhlář Rukověť ', description : 'Truhlář Rukověť '},
        '92' : {value : 'Vavákovy Pam. ', description : 'Vavákovy Pam. '},
        '93' : {value : 'Vávra Děj. Kolína ', description : 'Vávra Děj. Kolína '},
        '94' : {value : 'VČA ', description : 'VČA '},
        '95' : {value : 'Veleslav. Kal. ', description : 'Veleslav. Kal. '},
        '96' : {value : 'Wolný ', description : 'Wolný '},
        '97' : {value : 'ZDVM ', description : 'ZDVM '},
        '98' : {value : 'Zíbrt BČH ', description : 'Zíbrt BČH '},
        '99' : {value : 'Zíbrt z dějin Zvíkova ', description : 'Zíbrt z dějin Zvíkova '},
        '100' : {value : 'Zrc. ', description : 'Zrc. '}
      }
      break;
    case '6705':
      values = {
