...
from invenio.aip_utils import check_javascript_version_ctrl #TP: added javascript version control
...
<head>
 ...
 <script type="text/javascript" src="%(cssurl)s/js/invenio.js"></script>
 <script type="text/javascript" src="%(cssurl)s/js/fieldTemplates.js"></script>
 <link rel="stylesheet" type="text/css" href="%(cssurl)s/css/invenio.css" />
 %(jsvercheck)s
 %(metaheaderadd)s
</head>
...
%(pageheaderadd)s
        ...
        """ % {
          ...
          'jsvercheck' : ""
#          'jsvercheck' : check_javascript_version_ctrl()
        }
        return out
