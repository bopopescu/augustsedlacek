...
try:
    from invenio.supervisors_webinterface import WebInterfaceSupervisorsPages
except:
    register_exception(alert_admin=True, subject='EMERGENCY')
    WebInterfaceSupervisorsPages = WebInterfaceDumbPages
try:
...
class WebInterfaceInvenio(WebInterfaceSearchInterfacePages):
    ...
    supervisors = WebInterfaceSupervisorsPages()
