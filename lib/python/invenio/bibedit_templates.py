...
class Template:
    ...
    def menu(self):
        ...
        aiputils = '<div class="bibEditMenuSectionHeader">\n' \
            '          %(imgCompressMenuSection)sAdvanced tools\n' \
            '        </div>\n' \
            '        <table>\n' \
            '          <col width="136px">\n' \
            '          <tr class="bibEditMenuMore">\n' \
            '            <td>%(btnNextCardImages)s</td>\n' \
            '          </tr>\n' \
            '        </table>' % {
            'imgCompressMenuSection': img('/img/bullet_toggle_minus.png',
                            'bibEditImgCompressMenuSection', id='ImgAdvancedMenu'),
            'btnNextCardImages': button('button', 'Check running cards', id='btnNextCardImages'),
            }
