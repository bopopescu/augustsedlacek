...
from invenio.supervisors import perform_request_index, \
...
class WebInterfaceSupervisorsPages(WebInterfaceDirectory):
    ...
    def __call__(self, req, form):
        ...
        return page(title="Supervisors' Area",
                    body=perform_request_index(ln=ln),
                    description="CDS, Supervisors' Area",
                    keywords="CDS, Supervisors' Area",
                    req=req,
                    lastupdated=__lastupdated__,
                    navmenuid='supervisors',
                    language=ln)
    ...
    def customevent(self, req, form):
        ...
        return page(title="Custom event",
                    body=body,
                    navtrail="""<a class="navtrail" href="%s/supervisors/%s">Supervisors' Area</a>""" % \
                    (CFG_SITE_URL, (ln != CFG_SITE_LANG and '?ln=' + ln) or ''),
